...
{
    public class Atten_WorkFromHomeSetting
    {
        public double WFHSettingId { get; set; }
        public string WFHSettingId_Encrypted { get; set; }
        ...
        public double WFHSettingBranchId { get; set; }
