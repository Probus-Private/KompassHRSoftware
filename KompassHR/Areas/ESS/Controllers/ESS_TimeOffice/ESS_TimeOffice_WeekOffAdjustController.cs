...
{
    public class ESS_TimeOffice_WeekOffAdjustController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        // GET: ESS/ESS_TimeOffice_WeekOffAdjust
        #region WeekOffAdjust MAin View
        public ActionResult ESS_TimeOffice_WeekOffAdjust(Atten_WeekOffAdjust OBJAtten_WeekOffAdjust)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 158;
        ...
        #region IsValidation
        [HttpPost]
        public ActionResult IsWeekOfAdjustmentExists(DateTime WOAdjustDate, List<WeekOffAdjust> Record, DateTime WOFromDate, int? WOBranchId)
        {
            try
            {
        ...
        public ActionResult SaveUpdate(List<WeekOffAdjust> Record, int? CmpID, int? WODepartmentID, DateTime WOFromDate, DateTime WOAdjustDate)
        {
            try
            {
                ...
                {
                    return RedirectToAction("ESS_TimeOffice_WeekOffAdjust", "ESS_TimeOffice_WeekOffAdjust");
                }
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                if (WeekOffAdjustList.CmpId > 0)
                {
                    if ((WeekOffAdjustList.WOFromDate != null) && (WeekOffAdjustList.WOAdjustDate != null))
                    {
                        ...
                        paramList.Add("@p_WOFromDate", WeekOffAdjustList.WOFromDate);
