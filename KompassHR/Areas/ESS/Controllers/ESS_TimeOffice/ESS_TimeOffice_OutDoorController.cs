...
{
    public class ESS_TimeOffice_OutDoorController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);

        // GET: ESS/ESS_TimeOffice_OutDoor
        #region Out Door Main View
        [HttpGet]
        public ActionResult ESS_TimeOffice_OutDoor()
        {
            try
            {
        ...
        public ActionResult ESS_TimeOffice_GetApproveRejectList()
        {
            try
            {
                if (Session["EmployeeId"] == null)
        ...
        #region IsValidation
        [HttpGet]
        public ActionResult IsOutdoorExists(DateTime Fromdate, DateTime Todate, TimeSpan FromTime, TimeSpan ToTime, string OutDoorCompanyType, int ShiftId, bool IsNightShift)
        {
            try
            {
        ...
        public ActionResult SaveUpdate(Models.ESS_TimeOffice.Atten_OutDoorCompany attenOutDoor)
        {
            try
            {
                ...
                // Fetch data
                var Sendmessage = DapperORM.DynamicQueryList("SELECT * FROM tbl_NotificationMessage WHERE Origin='OD'").FirstOrDefault();
                ...
                return RedirectToAction("ESS_TimeOffice_OutDoor", "ESS_TimeOffice_OutDoor");
        ...
        public ActionResult OutDoorComapnyDelete(string OutDoorCompanyId_Encrypted, int OutDoorCompanyId)
        {
            try
            {
                ...
                TempData["Message"] = param.Get<string>("@p_msg");
                TempData["Icon"] = param.Get<string>("@p_Icon");
                return RedirectToAction("ESS_TimeOffice_GetApproveRejectList", "ESS_TimeOffice_OutDoor");
            }
            catch (Exception ex)
            {
                Session["GetErrorMessage"] = ex.Message;
        ...
        [HttpGet]
        public ActionResult CancelRequest(int? OutDoorCompanyId, int ddlManagerId, string Remark, string Origin)
        {
            try
            {
        ...
        #region GetLunchTime
        [HttpGet]
        public ActionResult GetLunchTime(int ShiftId)
        {
            try
            {
        ...
        public ActionResult OutInvoiceView(int? DocId)
        {
