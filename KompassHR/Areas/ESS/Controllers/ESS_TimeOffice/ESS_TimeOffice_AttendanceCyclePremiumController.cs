...
{
    public class ESS_TimeOffice_AttendanceCyclePremiumController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);

        // GET: TMSSetting/ProjectMaster
        public ActionResult ESS_TimeOffice_AttendanceCyclePremium(AttenCycle AttenCycle)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 886;
        ...
        #endregion
        public ActionResult IsAttendanceCycleExists(string CmpId, string AtdLockIDBranchId, string AtdType, string AttendanceCycleId_Encrypted,string PayrollCalculation)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                using (SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString))
                {
                    ...
                    param.Add("@p_PayrollCalculation", PayrollCalculation);
        ...
        public ActionResult SaveUpdate(AttenCycle AttenCycle)
        {
            try
            {
                ...
                param.Add("@p_PayrollCalculation", AttenCycle.PayrollCalculation);
                ...
                return RedirectToAction("ESS_TimeOffice_AttendanceCyclePremium", "ESS_TimeOffice_AttendanceCyclePremium");
        ...
        public ActionResult Delete(string AttendanceCycleId)
        {
            try
            {
                ...
                TempData["Message"] = param.Get<string>("@p_msg");
                TempData["Icon"] = param.Get<string>("@p_Icon");
                return RedirectToAction("GetList", "ESS_TimeOffice_AttendanceCyclePremium");
            }
            catch (Exception ex)
            {
                Session["GetErrorMessage"] = ex.Message;
