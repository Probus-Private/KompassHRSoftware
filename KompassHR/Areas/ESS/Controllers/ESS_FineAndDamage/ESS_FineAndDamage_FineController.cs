...
{
    public class ESS_FineAndDamage_FineController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        // GET: ESS/ESS_FineAndDamage_Fine
        #region Fine Main View
       public ActionResult ESS_FineAndDamage_Fine(string PenaltyID_Encrypted)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 221;
                ...
                var FineLastRecord = "select max(CreatedDate) As CreatedDate from Payroll_FineAndPenalty where PenaltyEmployeeID ="+ EmployeeId + "  and Deactivate = 0";
                var LastRecored = DapperORM.DynamicQuerySingle(FineLastRecord);
            ...
            {
                return RedirectToAction(ex.Message.ToString(), "ESS_FineAndDamage_Fine");
            }
        }
        #endregion
        ...
        public ActionResult SaveUpdate(Payroll_FineAndPenalty Fine)
        {
            ...
            {              
                ...
                param.Add("@p_RequesterID", EmployeeId);
                ...
                return RedirectToAction("ESS_FineAndDamage_Fine", "ESS_FineAndDamage_Fine");
            }
            catch (Exception ex)
            {
                return RedirectToAction(ex.Message.ToString(), "ESS_FineAndDamage_Fine");
        ...
        public ActionResult Delete(string PenaltyID_Encrypted)
        {
            try
            {
                ...
                TempData["Message"] = param.Get<string>("@p_msg");
                TempData["Icon"] = param.Get<string>("@p_Icon");
                return RedirectToAction("GetList", "ESS_FineAndDamage_Fine");
            }
            catch (Exception Ex)
            {
                return RedirectToAction(Ex.Message.ToString(), "ESS_FineAndDamage_Fine");
