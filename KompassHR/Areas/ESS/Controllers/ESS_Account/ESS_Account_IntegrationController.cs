...
{
    public class ESS_Account_IntegrationController : Controller
    {
        GetMenuList ClsGetMenuList = new GetMenuList();
        // GET: ESS/ESS_Account_Integration
        public ActionResult ESS_Account_Integration(int? id, int? ScreenId)
        {
            try
            {
