...
{
    public class ESS_VMS_VisitorInReportController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        // GET: /ESS/ESS_VMS_VisitorInReport/ESS_VMS_VisitorInReport
        public ActionResult ESS_VMS_VisitorInReport()
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 396;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime FromDate, DateTime ToDate)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("BusinessUnitWiseReports");
                ...
                var getDateWiseReports = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Visitor_Visitor_IN", paramList).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Visitor IN Report - (" + FromDate.ToString("dd/MMM/yyyy") + " - " + ToDate.ToString("dd/MMM/yyyy") + ")";
