...
{
    public class ESS_VMS_BusinessUnitWiseReportsController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        // GET: ESS/ESS_VMS_BusinessUnitWiseReports
        #region BusinessUnitWiseReports
        public ActionResult ESS_VMS_BusinessUnitWiseReports()
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 193;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime FromDate, DateTime ToDate)
        {
            try
            {
                ...
                worksheet.Cell(1, 1).Value = "Business Unit Wise Reports - (" + FromDate.ToString("dd/MMM/yyyy") + " - " + ToDate.ToString("dd/MMM/yyyy") + ")";
