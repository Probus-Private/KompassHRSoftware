...
{
    public class ESS_VMS_VisitorDetailsDateWiseController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        // GET: ESS/ESS_VMS_VisitorDetailsDateWise
        #region VisitorDetailsDateWise
        public ActionResult ESS_VMS_VisitorDetailsDateWise()
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 190;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime FromDate, DateTime ToDate)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("VisitorDateWiseReports");
                ...
                worksheet.Cell(1, 1).Value = "Visitor Date Wise Reports - (" + FromDate.ToString("dd/MMM/yyyy") + " - " + ToDate.ToString("dd/MMM/yyyy") + ")";
