...
{
    public class ESS_HRSpace_EmployeeTransferMenuController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        GetMenuList ClsGetMenuList = new GetMenuList();
        // GET: ESS/ESS_HRSpace_EmployeeTransferMenu
        public ActionResult ESS_HRSpace_EmployeeTransferMenu(int? id, int? ScreenId)
        {
            try
            {
