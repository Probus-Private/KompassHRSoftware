...
{
    public class Reports_Tax_RegimeDeclarationController : Controller
    {
        // GET: Reports/Reports_Tax_RegimeDeclaration
        public ActionResult Reports_Tax_RegimeDeclaration(TaxFilters Report)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 573;
                ...
                //      //  ViewBag.TaxRegimeDeclarationList = DapperORM.ExecuteSP<dynamic>("", paramList).ToList();
                //    }
                //    else
                //    {
                //        DynamicParameters paramList = new DynamicParameters();
                ...
                //else
                //{
                //    ViewBag.TaxRegimeDeclarationList = "";
                //    ViewBag.GetMasBranch = "";
                //}
                return View();
            }
        ...
        public ActionResult DownloadExcelFile(int FYearID, int RegimeTypeID, string  Fyear)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                var worksheet = workbook.Worksheets.Add("RegimeDeclarationReport");
                ...
                paramList.Add("@p_RegimeTypeTD", RegimeTypeID);
                var GetTaxComputationReport = DapperORM.ExecuteSP<dynamic>("sp_Tax_Rpt_RegimeDeclartion", paramList).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Regime Declaration Report - (" + Fyear + ")";
