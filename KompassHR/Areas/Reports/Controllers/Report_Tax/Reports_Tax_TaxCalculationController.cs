...
{
    public class Reports_Tax_TaxCalculationController : Controller
    {
        // GET: Reports/Reports_Tax_TaxCalculation
        public ActionResult Reports_Tax_TaxCalculation(TaxFilters Report)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 574;
                ...
                //    //    ViewBag.TaxCalculationList = DapperORM.ExecuteSP<dynamic>("", paramList).ToList();
                //    }
                //    else
                //    {
                //        DynamicParameters paramList = new DynamicParameters();
        ...
        public ActionResult DownloadExcelFile(int FYearID, DateTime MonthYear,string TType)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                var GetTaxComputationReport = DapperORM.ExecuteSP<dynamic>("sp_Tax_Rpt_TaxCalculation", paramList).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Tax Calculation Report- (" + SetMonth + ") - "+ TType + "";
