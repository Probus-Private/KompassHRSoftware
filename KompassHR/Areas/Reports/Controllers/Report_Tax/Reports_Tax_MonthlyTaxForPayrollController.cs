...
{
    public class Reports_Tax_MonthlyTaxForPayrollController : Controller
    {
        // GET: Reports/Reports_Tax_MonthlyTaxForPayroll
        public ActionResult Reports_Tax_MonthlyTaxForPayroll(TaxFilters Report)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 575;
                ...
                //      //  ViewBag.MonthlyTaxPayrollList = DapperORM.ExecuteSP<dynamic>("", paramList).ToList();
                //    }
                //    else
                //    {
                //        DynamicParameters paramList = new DynamicParameters();
        ...
        public ActionResult DownloadExcelFile(DateTime MonthYear)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                var worksheet = workbook.Worksheets.Add("MonthlyTaxForPayroll");
                ...
                var GetTaxComputationReport = DapperORM.ExecuteSP<dynamic>("sp_Tax_Rpt_MonthlyTaxForPayroll", paramList).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Monthly tax for payroll Report- (" + SetMonth + ")";
