...
{
    public class Reports_Tax_RptMenuController : Controller
    {
        GetMenuList ClsGetMenuList = new GetMenuList();
        // GET: ESS/Reports_Tax_RptMenu
        public ActionResult Reports_Tax_RptMenu(int? id, int? ScreenId)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 571;
