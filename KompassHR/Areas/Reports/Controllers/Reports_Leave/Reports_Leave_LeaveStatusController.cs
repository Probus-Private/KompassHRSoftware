...
{
    public class Reports_Leave_LeaveStatusController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        // GET: Reports/Reports_Leave_LeaveStatus

        #region Reports_Leave_LeaveStatus
        public ActionResult Reports_Leave_LeaveStatus(DailyAttendanceReportFilter MasReport)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 317;
                ...
                //    {
                //        Query = "where BranchId=" + MasReport.BranchId + "";
                ...
                //    paramList.Add("@p_FromDate", MasReport.FromDate);
                //    paramList.Add("@p_ToDate", MasReport.ToDate);
                //    var GetLateComing = DapperORM.ReturnList<dynamic>("sp_Rpt_Atten_LateComing", paramList).ToList();
                //    ViewBag.LateComingReport = GetLateComing;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime FromDate, int? SubUnitId, int? DepartmentId, int? SubDepartmentId, int? DesignationId, int? LineId, int? EmployeeID, int? GradeId, DateTime ToDate)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("LeaveStatusReport");
                ...
                worksheet.Cell(1, 1).Value = "Leave Status Report- (" + FromDate.ToString("dd/MMM/yyyy") + " - " + ToDate.ToString("dd/MMM/yyyy") + ")";
