...
{
    public class Reports_Leave_DepartmentVsLeaveReportController : Controller
    {
        #region Main View 
        // GET: Reports/Reports_Leave_DepartmentVsLeaveReport
        public ActionResult Reports_Leave_DepartmentVsLeaveReport()
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 741;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime Month)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("DepartmentVsLeaveReport");
                ...
                var GetData = DapperORM.ExecuteSP<dynamic>("sp_DepartmentVsLeave_Report", paramList).ToList();
                if (GetData.Count == 0)
                {
                ...
                worksheet.Cell(1, 1).Value = "Department Vs Leave Report - (" + Month.ToString("dd/MMM/yyyy") + ")";
