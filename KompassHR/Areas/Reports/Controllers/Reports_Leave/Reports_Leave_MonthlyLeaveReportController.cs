...
{
    public class Reports_Leave_MonthlyLeaveReportController : Controller
    {
        // GET: Reports/Reports_Leave_MonthlyLeaveReport
        #region Main View
        public ActionResult Reports_Leave_MonthlyLeaveReport()
        {
            ...
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 732;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime Month)
        {
            try
            {
                ...
                var GetData = DapperORM.ExecuteSP<dynamic>("sp_Monthly_Leave_Report", paramList).ToList();
                if (GetData.Count == 0)
                {
                ...
                worksheet.Cell(1, 1).Value = "Monthly Leave Report - (" + Month.ToString("dd/MMM/yyyy") + ")";
