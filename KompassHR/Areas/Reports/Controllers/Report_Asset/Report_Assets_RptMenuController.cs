...
{
    public class Report_Assets_RptMenuController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        GetMenuList ClsGetMenuList = new GetMenuList();

        #region Main View
        // GET: Reports/Report_Assets_RptMenu
        public ActionResult Report_Assets_RptMenu()
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) :841;
