...
{
    public class Rpt_ExitManagement_EmployeeResignationByHRController : Controller
    {
        // GET: Reports/Rpt_ExitManagement_EmployeeResignationByHR
        public ActionResult Rpt_ExitManagement_EmployeeResignationByHR(MonthWiseFilter MonthWiseFilter)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 865;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime FromMonthYear, DateTime ToMonthYear,string ResignationType)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                var worksheet = workbook.Worksheets.Add("ResignationReport");
                ...
                paramList.Add("@p_ResignationType", ResignationType);
                var GetData = DapperORM.ExecuteSP<dynamic>("sp_Rpt_FNF_EmployeeResignationByHrReport", paramList).ToList();
                if (GetData.Count == 0)
                {
                ...
                worksheet.Cell(1, 1).Value = "Resignation By HR Report - (" + FromMonthYear.ToString("dd/MMM/yyyy") + " to " + ToMonthYear.ToString("dd/MMM/yyyy") + ")";
