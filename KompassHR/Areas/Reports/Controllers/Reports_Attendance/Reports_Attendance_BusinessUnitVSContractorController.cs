...
{
    public class Reports_Attendance_BusinessUnitVSContractorController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        // GET: /Reports/Reports_Attendance_BusinessUnitVSContractor/Reports_Attendance_BusinessUnitVSContractor
        public ActionResult Reports_Attendance_BusinessUnitVSContractor(HeadCountSummary HeadCount)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 398;
        ...
        public ActionResult DownloadExcelFile(int? CmpId,  DateTime FromTime, string[] GradeId, DateTime ToTime, DateTime txtDate)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("BusinessUnitVSContractor");
                ...
                var ContractorVSBusinessUnit = DapperORM.ReturnList<dynamic>("sp_Rpt_Atten_BusinessUnitVSContractor", param).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Business Unit VS Contractor - (" + txtDate.ToString("dd/MMM/yyyy") + ")";
