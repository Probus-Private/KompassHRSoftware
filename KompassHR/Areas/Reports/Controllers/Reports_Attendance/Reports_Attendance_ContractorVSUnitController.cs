...
{
    public class Reports_Attendance_ContractorVSUnitController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        // GET: Reports/Reports_Attendance_ContractorVSUnit
        #region Reports_Attendance_ContractorVSUnit
        public ActionResult Reports_Attendance_ContractorVSUnit(HeadCountSummary HeadCount)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 372;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime FromTime, string[] GradeId, DateTime ToTime, DateTime txtDate)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                var worksheet = workbook.Worksheets.Add("ContractorVSSubUnit");
                ...
                var ContractorVSUnitData = DapperORM.ReturnList<dynamic>("sp_Rpt_Atten_ContractorVSUnit", param).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Contractor VS SubUnit - (" + txtDate.ToString("dd/MMM/yyyy") + ")";
