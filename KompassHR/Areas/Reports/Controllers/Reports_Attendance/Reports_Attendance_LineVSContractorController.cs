...
{
    public class Reports_Attendance_LineVSContractorController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        // GET: Reports/Reports_Attendance_LineVSContractor
        #region Reports_Attendance_LineVSContractor
        public ActionResult Reports_Attendance_LineVSContractor(HeadCountSummary HeadCount)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 353;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, string[] GradeId, DateTime txtDate, TimeSpan FromTime, TimeSpan ToTime)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("LineVSContractor");
                ...
                var ContractorVSUnitData = DapperORM.ReturnList<dynamic>("sp_Rpt_Atten_LineVSContractor", param).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Line VS Contractor Report - (" + txtDate.ToString("dd/MMM/yyyy") + ")";
