...
{
    public class Reports_Attendance_DepartmentWiseMonthlyHeadCountController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        // GET: Reports/Reports_Attendance_DepartmentWiseMonthlyHeadCount
        #region Reports_Attendance_DepartmentWiseMonthlyHeadCount
        public ActionResult Reports_Attendance_DepartmentWiseMonthlyHeadCount(HeadCountSummary HeadCount)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 347;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime FromDate, DateTime ToDate)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("DepartmentWiseMonthlyHeadCount");
                ...
                data = DapperORM.ReturnList<dynamic>("sp_Rpt_Atten_DepartmentWiseMonthlyHeadCount", param).ToList();
                if (data.Count == 0)
                {
                ...
                worksheet.Cell(1, 1).Value = "Department Wise Monthly Head Count Report - (" + FromDate.ToString("dd/MMM/yyyy") + " - " + ToDate.ToString("dd/MMM/yyyy") + ")";
