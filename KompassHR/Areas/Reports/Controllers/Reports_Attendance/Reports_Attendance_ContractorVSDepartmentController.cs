...
{
    public class Reports_Attendance_ContractorVSDepartmentController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        // GET: Reports/Reports_Attendance_ContractorVSDepartment
        #region Reports_Attendance_ContractorVSDepartment
        public ActionResult Reports_Attendance_ContractorVSDepartment(HeadCountSummary HeadCount)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 348;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, string[] GradeId, DateTime txtDate, TimeSpan FromTime, TimeSpan ToTime)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("ContractorVSDepartment");
                ...
                var ContractorVSUnitData = DapperORM.ReturnList<dynamic>("sp_Rpt_Atten_ContractorVSDepartment", param).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Contractor VS Department Report - (" + txtDate.ToString("dd/MMM/yyyy") + ")";
