...
{
    public class Rpt_AdjustPunchesController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        // GET: Reports/Rpt_AdjustPunches
        #region _AdjustPunches
        public ActionResult Rpt_AdjustPunches(DailyAttendanceReportFilter MasReport)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 357;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime FromDate, int? SubUnitId, int? DepartmentId, int? SubDepartmentId, int? DesignationId, int? LineId, int? EmployeeID, int? GradeId, DateTime ToDate,int? ContractorId)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("ManipulationofPunchbyAdmin");
                ...
                var GetPunchAdjust = DapperORM.ReturnList<dynamic>("sp_Rpt_Atten_PunchAdjust", paramList).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Manipulation of Punch in by Admin - (" + FromDate.ToString("dd/MMM/yyyy") + " - " + ToDate.ToString("dd/MMM/yyyy") + ")";
