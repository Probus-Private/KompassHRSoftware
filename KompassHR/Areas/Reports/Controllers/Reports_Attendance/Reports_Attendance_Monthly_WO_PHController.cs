...
{
    public class Reports_Attendance_Monthly_WO_PHController : Controller
    {
        // GET: Reports/Reports_Attendance_Monthly_WO_PH
        DynamicParameters param = new DynamicParameters();
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        #region Reports_Attendance_Monthly_WO_PH
        public ActionResult Reports_Attendance_Monthly_WO_PH(DailyAttendanceReportFilter Obj)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 373;
        ...
        public ActionResult DownloadExcelFile(int? BranchId, DateTime FromDate,int CmpId,int ? ContractorId)
        {
            try
            {
                ...
                foreach (var branch in selectedBranches)
                {
                    ...
                    data = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Atten_MusterRoll_WO_PH", param).ToList();
                    ...
                    // Set the header row
                    worksheet.Cell(1, 1).Value = "WeeklyOff And Public Holiday - (" + FromDate.ToString("MMM/yyyy") + ") - " + branchName;
                    ...
                    var range = worksheet.Range(2, 21, 2, dt.Columns.Count);
                    ...
                    var rangee = worksheet.Range("V2:AZ" + worksheet.LastRowUsed().RowNumber());

                    var woPCells = rangee.Cells(c => c.Value.ToString() == "WO(P)");
