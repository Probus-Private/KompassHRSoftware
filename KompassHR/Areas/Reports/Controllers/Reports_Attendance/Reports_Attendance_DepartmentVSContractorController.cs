...
{
    public class Reports_Attendance_DepartmentVSContractorController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        // GET: Reports/Reports_Attendance_DepartmentVSContractor
        #region Reports_Attendance_DepartmentVSContractor
        public ActionResult Reports_Attendance_DepartmentVSContractor(HeadCountSummary HeadCount)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 351;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, string[] GradeId, DateTime txtDate, TimeSpan FromTime, TimeSpan ToTime)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("DepartmentVSContractor");
                ...
                param.Add("@p_Branchid", BranchId);
                var ContractorVSUnitData = DapperORM.ReturnList<dynamic>("sp_Rpt_Atten_DepartmentVSContractor", param).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Department VS Contractor Report - (" + txtDate.ToString("dd/MMM/yyyy") + ")";
