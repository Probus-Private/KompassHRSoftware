...
{
    public class Reports_Attendance_ContractorVSLineController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        // GET: Reports/Reports_Attendance_ContractorVSLine
        #region Reports_Attendance_ContractorVSLine
        public ActionResult Reports_Attendance_ContractorVSLine(HeadCountSummary HeadCount)
        {
            ...
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 350;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, string[] GradeId, DateTime txtDate, TimeSpan FromTime, TimeSpan ToTime)
        {
            try
            {
                ...
                var ContractorVSUnitData = DapperORM.ReturnList<dynamic>("sp_Rpt_Atten_ContractorVSLine", param).ToList();
