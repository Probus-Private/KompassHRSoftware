...
{
    public class Rpt_Attendance_MusterAttendance_ActualAttendanceController : Controller
    {
        #region Main view
        // GET: Reports/Rpt_Attendance_MusterAttendance_ActualAttendance
        public ActionResult Rpt_Attendance_MusterAttendance_ActualAttendance()
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 936;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, int? EmployeeId, DateTime MonthYear)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                var worksheet = workbook.Worksheets.Add("MusterVsActualAttendanceReport");
                ...
                var GetData = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Attendance_MusterVsActualReport", paramList).ToList();
                if (GetData.Count == 0)
                {
                ...
                worksheet.Cell(1, 1).Value = "Muster Vs Actual Attendance Report";
