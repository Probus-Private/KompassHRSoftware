...
{
    public class Reports_Attendance_DesignationVSContractorController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        // GET: Reports/Reports_Attendance_DesignationVSContractor
        #region Reports_Attendance_DesignationVSContractor
        public ActionResult Reports_Attendance_DesignationVSContractor(HeadCountSummary HeadCount)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 352;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, string[] GradeId, DateTime txtDate, TimeSpan FromTime, TimeSpan ToTime)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("DesignationVSContractor");
                ...
                var ContractorVSUnitData = DapperORM.ReturnList<dynamic>("sp_Rpt_Atten_DesignationVSContractor", param).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Designation VS Contractor Report - (" + txtDate.ToString("dd/MMM/yyyy") + ")";
