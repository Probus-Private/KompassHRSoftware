...
{
    public class Report_Recruitment_ShortListedAndRejectedCandidateController : Controller
    {
        #region Main View
        // GET: Reports/Report_Recruitment_ShortListedAndRejectedCandidate
        public ActionResult Report_Recruitment_ShortListedAndRejectedCandidate()
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 923;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, string ResumeStatus)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                var worksheet = workbook.Worksheets.Add("ShortListedRejectedDetails");
                ...
                paramList.Add("@P_ResumeStatus", ResumeStatus);
            

                var Recruitment_AgencyDetails = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Recruitment_ShortListedAndRejectedCandidates", paramList).ToList();
                ...
                worksheet.Cell(1, 1).Value = "ShortListed  Rejected Candidates ";
