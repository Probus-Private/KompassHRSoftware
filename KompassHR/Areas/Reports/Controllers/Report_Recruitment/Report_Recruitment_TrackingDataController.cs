...
{
    public class Report_Recruitment_TrackingDataController : Controller
    {
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        DynamicParameters param = new DynamicParameters();
        // GET: Reports/Report_Recruitment_TrackingData
        public ActionResult Report_Recruitment_TrackingData(DailyAttendanceReportFilter MasReport)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 395;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, int? DepartmentId, int? DesignationId, DateTime FromDate, DateTime ToDate)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("TrackingDataReport");
                ...
                data = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Recruitment_OfferedLetterData", paramList).ToList();
                if (data.Count == 0)
                {
                ...
                worksheet.Cell(1, 1).Value = "Tracking Data Report - (" + FromDate.ToString("dd/MMM/yyyy") + " - " + ToDate.ToString("dd/MMM/yyyy") + ")";
