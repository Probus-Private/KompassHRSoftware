...
{
    public class Report_Recruitment_OfferedLetterDataController : Controller
    {
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        DynamicParameters param = new DynamicParameters();
        // GET: Reports/Report_Recruitment_OfferedLetterData
        #region OfferedLetterData
        public ActionResult Report_Recruitment_OfferedLetterData(DailyAttendanceReportFilter MasReport)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 393;
