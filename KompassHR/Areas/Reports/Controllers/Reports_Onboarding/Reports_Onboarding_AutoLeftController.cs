...
{
    public class Reports_Onboarding_AutoLeftController : Controller
    {
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        DynamicParameters param = new DynamicParameters();
        // GET: Reports/Reports_Onboarding_AutoLeft/Reports_Onboarding_AutoLeft
        public ActionResult Reports_Onboarding_AutoLeft(DailyAttendanceReportFilter MasReport)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 390;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime FromDate, DateTime ToDate, int? SubUnitId, int? DepartmentId, int? SubDepartmentId, int? DesignationId, int? LineId, int? ContractorId, int? GradeId)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                var LeftEmployeeReportList = DapperORM.ReturnList<dynamic>("Sp_Rpt_Onboarding_AutoLeftEmployeeList", paramList).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Auto Inactive Employee (Left) Report - (" + FromDate.ToString("dd/MMM/yyyy") + " - " + ToDate.ToString("dd/MMM/yyyy") + ")"; ;
