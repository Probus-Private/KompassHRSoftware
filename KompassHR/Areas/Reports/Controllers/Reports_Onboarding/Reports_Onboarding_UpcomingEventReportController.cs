...
{
    #region Main View
    public class Reports_Onboarding_UpcomingEventReportController : Controller
    {
        // GET: Reports/Reports_Onboarding_UpcomingEventReport
     
        public ActionResult Reports_Onboarding_UpcomingEventReport()
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 725;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime Month, string EventType)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                var worksheet = workbook.Worksheets.Add("UpcomingEventReport");
                ...
                paramList.Add("@p_EventType", EventType);
                var GetData = DapperORM.ExecuteSP<dynamic>("sp_Onboarding_UpcomingEventReport", paramList).ToList();
                if (GetData.Count == 0)
                {
                ...
                worksheet.Cell(1, 1).Value = "Upcoming Event Report - (" + Month.ToString("dd/MMM/yyyy") + ")";
