...
{
    public class Reports_Onboarding_GenderWiseListController : Controller
    {
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        DynamicParameters param = new DynamicParameters();
        // GET: Reports/Reports_Onboarding_GenderWiseList
        #region Reports_Onboarding_GenderWiseList
        public ActionResult Reports_Onboarding_GenderWiseList(DailyAttendanceReportFilter MasReport)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 277;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, int? SubUnitId, int? DepartmentId, int? SubDepartmentId, int? DesignationId, int? LineId, int? GradeId,string Gender,int? ContractorId)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                var worksheet = workbook.Worksheets.Add("GenderWiseEmployee");
                ...
                if (CmpId != null)
                {
                    ...
                    if (Gender != null)
                    {
                        Query = Query + " and Mas_Employee_Personal.Gender='" + Gender + "'";
                    }
                ...
                var EmployeeReportList = DapperORM.ReturnList<dynamic>("sp_Rpt_Onboarding_GenderRatioList", paramList).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Gender Wise Employee Report";
