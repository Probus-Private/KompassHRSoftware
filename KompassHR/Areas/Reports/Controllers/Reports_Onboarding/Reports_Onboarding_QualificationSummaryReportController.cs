...
{
    public class Reports_Onboarding_QualificationSummaryReportController : Controller
    {
        // GET: Reports/Rpt_Payroll_BranchUnitWiseSummary
        public ActionResult Reports_Onboarding_QualificationSummaryReport(MonthWiseFilter MonthWiseFilter)
        {
            try
            {
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("QualificationSummaryReport");
                ...
                var GetData = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Onboarding_QualificationSummaryReport", paramList).ToList();
                if (GetData.Count == 0)
                {
                ...
                worksheet.Cell(1, 1).Value = "Qualification Summary Report";
