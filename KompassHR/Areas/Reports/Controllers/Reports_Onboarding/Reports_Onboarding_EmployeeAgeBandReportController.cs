...
{
    public class Reports_Onboarding_EmployeeAgeBandReportController : Controller
    {
        // GET: Reports/Reports_Onboarding_EmployeeAgeBandReport
        public ActionResult Reports_Onboarding_EmployeeAgeBandReport(EmployeeAgeBond EmployeeAgeBond)
        {
            try
            {
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId,int Age)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                var worksheet = workbook.Worksheets.Add("EmployeeAgeBandReport");
                ...
                paramList.Add("@p_Age", Age);
                // paramList.Add("@p_MonthYear", Month);
                var GetData = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Onboarding_EmployeeAgeBand", paramList).ToList();
                if (GetData.Count == 0)
                {
                ...
                worksheet.Cell(1, 1).Value = "Employee Age Band Report";
