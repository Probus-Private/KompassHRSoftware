...
{
    public class Reports_Onboarding_DuplicateDetailsMappingReportController : Controller
    {
        // GET: Reports/Reports_Onboarding_DuplicateDetailsMappingReport
        public ActionResult Reports_Onboarding_DuplicateDetailsMappingReport(DuplicateDetails DuplicateDetails)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 739;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId,string Duplicate,string Type)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                var worksheet = workbook.Worksheets.Add("DuplicateDetailsMappingReport");
                ...
                paramList.Add("@p_Duplicate", Duplicate);
                paramList.Add("@p_Type", Type);
                var GetData = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Onboarding_DuplicateDetailsMapping", paramList).ToList();
                if (GetData.Count == 0)
                {
                ...
                worksheet.Cell(1, 1).Value = "Duplicate Details Mapping Report" + Duplicate;
