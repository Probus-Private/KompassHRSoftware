...
{
    public class Reports_Onboarding_TenureEmployeeController : Controller
    {
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        DynamicParameters param = new DynamicParameters();
        // GET: Reports/Reports_Onboarding_TenureEmployee

        #region TenureEmployee
        public ActionResult Reports_Onboarding_TenureEmployee(DailyAttendanceReportFilter MasReport)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 304;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, int? SubUnitId, int? DepartmentId, int? SubDepartmentId, int? DesignationId, int? LineId, string AadharNo, int? GradeId)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                if (CmpId != null)
                {
                    ...
                    if (AadharNo != "")
                    {
                        Query = Query + " and Mas_Employee_Personal.AddhaNo=" + AadharNo + "";
                    }
                }
