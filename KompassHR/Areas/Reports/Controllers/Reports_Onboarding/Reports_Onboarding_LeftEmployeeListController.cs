...
{
    public class Reports_Onboarding_LeftEmployeeListController : Controller
    {
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        DynamicParameters param = new DynamicParameters();
        // GET: Reports/Reports_Onboarding_LeftEmployeeList
        #region LeftEmployeeList
        public ActionResult Reports_Onboarding_LeftEmployeeList(DailyAttendanceReportFilter MasReport)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 276;
        ...
        public ActionResult GetUnit(int? CmpId, int? UnitBranchId)
        {
            try
            {
                ...
                if (UnitBranchId != null)
                {
                    ...
                    DynamicParameters param2 = new DynamicParameters();
                    param2.Add("@p_qry", " and Mas_ContractorMapping.BranchID=" + UnitBranchId + " and Contractor_Master.ContractorID<>1");
                    var GetContractorDropdown = DapperORM.ReturnList<AllDropDownBind>("sp_GetContractorDropdown", param2).ToList();
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime FromDate, int? SubUnitId, int? DepartmentId, int? SubDepartmentId, int? DesignationId, int? LineId, int? GradeId, DateTime ToDate,int? ContractorId)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                var worksheet = workbook.Worksheets.Add("LeftEmployeeReport");
                ...
                var LeftEmployeeReportList = DapperORM.ReturnList<dynamic>("Sp_Rpt_Onboarding_LeftEmployeeList", paramList).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Left Employee Report - (" + FromDate.ToString("dd/MMM/yyyy") + " - " + ToDate.ToString("dd/MMM/yyyy") + ")";
