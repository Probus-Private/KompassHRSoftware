...
{
    public class Reports_Onboarding_EmployeeReportListController : Controller
    {
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        DynamicParameters param = new DynamicParameters();
        // GET: Reports/Reports_Onboarding_EmployeeReportList
        #region Reports_Onboarding_EmployeeReportList
        public ActionResult Reports_Onboarding_EmployeeReportList(DailyAttendanceReportFilter MasReport)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 144;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, int? SubUnitId, int? DepartmentId, int? SubDepartmentId, int? DesignationId, int? LineId, int? EmployeeID, int? GradeId,int? ContractorId)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                var worksheet = workbook.Worksheets.Add("ActiveEmployeeReport");
                ...
                if (CmpId != null)
                {
                    ...
                    if (GradeId != null)
                    {
                        Query = Query + " and Mas_Employee.EmployeeGradeID=" + GradeId + "";
                    }
                    if (SubUnitId != null)
                    {
                ...
                var EmployeeReportList = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Onboarding_ActiveEmployee", paramList).ToList();
                ...
                dt = dprObj.ConvertToDataTable(EmployeeReportList);
                ...
                worksheet.Cell(1, 1).Value = "Active Employee Report - (" + FromDate.ToString("dd/MMM/yyyy") + ")";
