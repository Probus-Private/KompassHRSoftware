...
{
    public class Reports_Onboarding_ProbationVsConfirmedReportController : Controller
    {
        // GET: Reports/Rpt_Payroll_BranchUnitWiseSummary
        public ActionResult Reports_Onboarding_ProbationVsConfirmedReport(MonthWiseFilter MonthWiseFilter)
        {
            try
            {
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("ProbationVsConfirmedReport");
               ...
               // paramList.Add("@p_MonthYear", Month);
                ...
                var GetData = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Onboarding_ProbationVsConfirmed", paramList).ToList();
                if (GetData.Count == 0)
                {
                ...
                worksheet.Cell(1, 1).Value = "Probation Vs Confirmed Report";
