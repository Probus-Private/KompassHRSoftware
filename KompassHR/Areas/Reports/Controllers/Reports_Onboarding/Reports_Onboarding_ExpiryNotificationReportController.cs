...
{
    public class Reports_Onboarding_ExpiryNotificationReportController : Controller
    {
        // GET: Reports/Reports_Onboarding_ExpiryNotificationReport
        public ActionResult Reports_Onboarding_ExpiryNotificationReport(ExpiryNotification ExpiryNotification)
        {
            try
            {
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId,string Type, DateTime? MonthYear,bool IsAll)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                var worksheet = workbook.Worksheets.Add("ExpiryNotificationReportReport");
                ...
                paramList.Add("@p_IsAll", IsAll);
                var GetData = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Onboarding_ExpiryNotificationReport", paramList).ToList();
                if (GetData.Count == 0)
                {
                ...
                worksheet.Cell(1, 1).Value = "Expiry Notification Report -" + Type;
