...
{
    public class Reports_Onboarding_EmployeeTypeDistributionReportController : Controller
    {
        // GET: Reports/Rpt_Payroll_BranchUnitWiseSummary
        public ActionResult Reports_Onboarding_EmployeeTypeDistributionReport(MonthWiseFilter MonthWiseFilter)
        {
            try
            {
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("EmployeeTypeDistributionReport");
                ...
                var GetData = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Onboarding_EmployeeTypeDistribution", paramList).ToList();
                if (GetData.Count == 0)
                {
                ...
                worksheet.Cell(1, 1).Value = "Employee Type Distribution Report";
