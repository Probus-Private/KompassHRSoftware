...
{
    public class Reports_Onboarding_DesignationAndGradeMatrixReportController : Controller
    {
        // GET: Reports/Reports_Onboarding_DesignationAndGradeMatrixReport
        #region Main View
        public ActionResult Reports_Onboarding_DesignationAndGradeMatrixReport()
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 721;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime Month)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("DesignationAndGradeReport");
                ...
                var GetData = DapperORM.ExecuteSP<dynamic>("sp_Designation_And_Grade_Report", paramList).ToList();
                if (GetData.Count == 0)
                {
                ...
                worksheet.Cell(1, 1).Value = "Onboarding Designation & Grade Report - (" + Month.ToString("dd/MMM/yyyy") + ")";
