...
{
    public class Reports_Onboarding_AssetWiseReportController : Controller
    {
        // GET: Reports/Reports_Onboarding_AssetWiseReport
        #region Main View 
        public ActionResult Reports_Onboarding_AssetWiseReport()
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 754;
        ...
        #region GetAssetName
        [HttpGet]
        public ActionResult GetAssetNameWise(int CmpId, int BranchId)
        {
            try
            {
                if (Session["EmployeeId"] == null)
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, int?AssetId, DateTime? Month = null)
        {
            try
            {
               ...
               paramList.Add("@p_EmployeeId", Session["EmployeeId"]);
                ...
                var GetData = DapperORM.ExecuteSP<dynamic>("sp_Onboarding_Asset", paramList).ToList();
