...
{
    public class Reports_Onboarding_MonthlyOnboardingReportController : Controller
    {
        // GET: Reports/Reports_Onboarding_MonthlyOnboardingReport
    #region Main View
        public ActionResult Reports_Onboarding_MonthlyOnboardingReport()
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 719;
    ...
    #region Get Branch Name
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime Month)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("OnbordingRegisterReport");
                ...
                var GetData = DapperORM.ExecuteSP<dynamic>("sp_Monthly_Onboarding_Report", paramList).ToList();
                if (GetData.Count == 0)
                {
                ...
                worksheet.Cell(1, 1).Value = "Monthly Onboarding Report - (" + Month.ToString("dd/MMM/yyyy") + ")";
