...
{
    public class Rpt_Payroll_CTCMasterController : Controller
    {
        // GET: Reports/Rpt_Payroll_BranchUnitWiseSummary
        public ActionResult Rpt_Payroll_CTCMaster(MonthWiseFilter MonthWiseFilter)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 472;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, bool statuory)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                var worksheet = workbook.Worksheets.Add("BranchWiseSummary");
                ...
                var GetDailyAttendanceReport = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Payroll_CTCMaster", paramList).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Payroll CTC Master ";
