...
{
    public class Rpt_Payroll_CategoryWiseSummaryController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        // GET: Reports/Rpt_Payroll_CategoryWiseSummary
        public ActionResult Rpt_Payroll_CategoryWiseSummary(MonthWiseFilter MonthWiseFilter)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 468;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime Month, string Title)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                var worksheet = workbook.Worksheets.Add("CategoryWiseSummary");
                ...
                var GetDailyAttendanceReport = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Payroll_CategoryWiseSummary", paramList).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Payroll Catogery Wise Summary - (" + Month.ToString("dd/MMM/yyyy") + " (" + Title + "))";
