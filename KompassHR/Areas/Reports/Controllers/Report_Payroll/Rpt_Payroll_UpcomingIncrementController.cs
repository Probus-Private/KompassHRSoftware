...
{
    public class Rpt_Payroll_UpcomingIncrementController : Controller
    {
        // GET: Reports/Rpt_Payroll_UpcomingIncrement
        public ActionResult Rpt_Payroll_UpcomingIncrement(MonthWiseFilter MonthWiseFilter)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 490;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime Month)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("Upcoming Increment");
                ...
                var GetDailyAttendanceReport = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Payroll_UpcomingIncrement", paramList).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Upcoming Increment Sheet Report - (" + Month.ToString("dd/MMM/yyyy") + ")";
