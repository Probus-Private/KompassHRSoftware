...
{
    public class Rpt_Payroll_EmployeeIncrementHistoryController : Controller
    {
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        DynamicParameters param = new DynamicParameters();
        clsCommonFunction objcon = new clsCommonFunction();
        // GET: Reports/Rpt_Payroll_EmployeeIncrementHistory
        #region Rpt_Payroll_EmployeeIncrementHistory
        public ActionResult Rpt_Payroll_EmployeeIncrementHistory(MonthWiseFilter MonthWiseFilter)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 471;
                ...
                //GET EMPLOYEE NAME
                var BID = Branch[0].Id;
                var Employee = new BulkAccessClass().GetEmployeeName(Convert.ToInt32(BID));
        ...
        public ActionResult GetEmployeeName(int BranchId)
        {
            try
            {
                ...
                var Employee = new BulkAccessClass().GetEmployeeName(Convert.ToInt32(BranchId));
        ...
        public ActionResult DownloadExcelFile(int? BranchId, int? CmpId, int? EmployeeId)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("EmployeeIncrementHistory");
                ...
                var GetEmployeeIncrementHistory = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Payroll_EmployeeIncrementHistory", paramList).ToList();

                if (GetEmployeeIncrementHistory.Count == 0)
                {
                ...
                dt = dprObj.ConvertToDataTable(GetEmployeeIncrementHistory);
                ...
                worksheet.Cell(8, 1).Value = "Employee Increment History";
