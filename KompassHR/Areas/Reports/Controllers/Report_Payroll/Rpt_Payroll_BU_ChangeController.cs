...
{
    public class Rpt_Payroll_BU_ChangeController : Controller
    {
        // GET: Reports/Rpt_Payroll_BU_Change
        #region Main View
        public ActionResult Rpt_Payroll_BU_Change()
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) :751;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime Month)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("BUChangeReport");
                ...
                var GetData = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Payroll_BU_Change", paramList).ToList();
                if (GetData.Count == 0)
                {
                ...
                worksheet.Cell(1, 1).Value = "Buisness Unit Change - (" + Month.ToString("dd/MMM/yyyy") + ")";
