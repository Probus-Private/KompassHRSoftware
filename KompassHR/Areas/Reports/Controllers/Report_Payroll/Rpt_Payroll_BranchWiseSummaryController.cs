...
{
    public class Rpt_Payroll_BranchWiseSummaryController : Controller
    {
        // GET: Reports/Rpt_Payroll_BranchUnitWiseSummary
        public ActionResult Rpt_Payroll_BranchWiseSummary(MonthWiseFilter MonthWiseFilter)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 466;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime FromMonth, DateTime ToMonth, string Title)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                var worksheet = workbook.Worksheets.Add("BusinessUnitWiseSummary");
                ...
                var GetDailyAttendanceReport = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Payroll_BUWiseSummary", paramList).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Business Unit Wise Summary - (" + FromMonth.ToString("MMM/yyyy") + "- " + ToMonth.ToString("MMM/yyyy") + " (" + Title + "))";
