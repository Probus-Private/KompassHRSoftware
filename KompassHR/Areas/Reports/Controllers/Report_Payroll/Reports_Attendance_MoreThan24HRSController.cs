...
namespace KompassHR.Areas.Reports.Controllers
{
    public class Reports_Attendance_MoreThan24HRSController : Controller
    {
        // GET: Reports/Reports_Attendance_MoreThan24HRS
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        DynamicParameters param = new DynamicParameters();

        public ActionResult Reports_Attendance_MoreThan24HRS(DailyAttendanceReportFilter MasReport)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 502;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime FromDate, int? SubUnitId, int? DepartmentId, int? SubDepartmentId, int? DesignationId, int? LineId, int? EmployeeID, int? GradeId, DateTime ToDate, int? ContractorId)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("MoreThan24HRSReport");
                ...
                var GetDailyAttendanceReport = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Atten_MoreThan24HRS", paramList).ToList();
                ...
                worksheet.Cell(1, 1).Value = "More Than 24 HRS Report - (" + FromDate.ToString("dd/MMM/yyyy") + " - " + ToDate.ToString("dd/MMM/yyyy") + ")";
