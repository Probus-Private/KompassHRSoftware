...
{
    public class Rpt_Payroll_ArrearsSheetController : Controller
    {
        // GET: Reports/Rpt_Payroll_ArreasSheet
        public ActionResult Rpt_Payroll_ArrearsSheet(MonthWiseFilter MonthWiseFilter)
        {
            try
            {
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime Month)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("ArrearsSheetReport");
                ...
                var GetData = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Payroll_ArrearsSheet", paramList).ToList();
                if (GetData.Count == 0)
                {
                ...
                worksheet.Cell(1, 1).Value = "Arrears Sheet  - (" + Month.ToString("dd/MMM/yyyy") + ")";
