...
{
    public class Rpt_Payroll_HoldSalaryController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        // GET: Reports/Rpt_Payroll_HoldSalary
        #region Rpt_Payroll_HoldSalary
        public ActionResult Rpt_Payroll_HoldSalary(MonthWiseFilter MonthWiseFilter)
        {
            try
            {
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime ToDate, DateTime FromDate)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                var worksheet = workbook.Worksheets.Add("Hold Salary");
                ...
                var GetDailyAttendanceReport = DapperORM.ExecuteSP<dynamic>("Rpt_Payroll_HoldSalary", paramList).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Hold Salary Sheet Report - (" + FromDate.ToString("dd/MMM/yyyy") + ") To (" + ToDate.ToString("dd/MMM/yyyy") + ")";
