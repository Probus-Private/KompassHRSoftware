...
{
    public class Rpt_Payroll_NewEmployeeProcessController : Controller
    {
        // GET: Reports/Rpt_Payroll_NewEmployeeProcess
        public ActionResult Rpt_Payroll_NewEmployeeProcess(MonthWiseFilter MonthWiseFilter)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 764;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime Month)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("NewEmployeeProcessReport");
                ...
                var GetData = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Payroll_NewEmployeeProcess", paramList).ToList();
                if (GetData.Count == 0)
                {
                ...
                worksheet.Cell(1, 1).Value = "New Employee Process - (" + Month.ToString("dd/MMM/yyyy") + ")";
