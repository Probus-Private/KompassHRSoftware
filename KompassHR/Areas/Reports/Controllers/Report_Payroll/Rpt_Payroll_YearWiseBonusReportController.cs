...
{
    public class Rpt_Payroll_YearWiseBonusReportController : Controller
    {
        // GET: Reports/Rpt_Payroll_YearWiseBonusReport
        public ActionResult Rpt_Payroll_YearWiseBonusReport(MonthWiseFilter MonthWiseFilter)
        {
            try
            {
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime FromMonthYear, DateTime ToMonthYear)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("YearWiseBonus");
                ...
                paramList.Add("@p_process", "YearWiseBonus");
                ...
                var GetDailyAttendanceReport = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Payroll_BonusReport", paramList).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Year Wise Bonus Report - (" + FromMonthYear.ToString("dd/MMM/yyyy") + " to " + ToMonthYear.ToString("dd/MMM/yyyy") + ")";
