...
{
    public class Rpt_Payroll_AdvanceSummaryController : Controller
    {
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        DynamicParameters param = new DynamicParameters();
        GetMenuList ClsGetMenuList = new GetMenuList();
        // GET: Reports/Rpt_Payroll_AdvanceSummary
        #region Rpt_Payroll_AdvanceSummary
        public ActionResult Rpt_Payroll_AdvanceSummary()
        {
            try
            {
        ...
        public ActionResult DownloadExcelFile(int? CmpId, DateTime FromDate)
        {
            try
            {
                if (Session["EmployeeId"] == null)
                ...
                var worksheet = workbook.Worksheets.Add("Advance Summary");
                ...
                paramList.Add("@p_FromMonth", FromDate);
                paramList.Add("@p_CmpId", CmpId);
                var GetDailyAttendanceReport = DapperORM.ExecuteSP<dynamic>("sp_Rpt_PayrollAdvance_Summary", paramList).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Advance Summary Report - (" + FromDate.ToString("dd/MMM/yyyy") + ")";
