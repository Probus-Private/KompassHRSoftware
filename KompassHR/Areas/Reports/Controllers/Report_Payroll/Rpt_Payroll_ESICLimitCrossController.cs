...
{
    public class Rpt_Payroll_ESICLimitCrossController : Controller
    {
        SqlConnection sqlcon = new SqlConnection(DapperORM.connectionString);
        DynamicParameters param = new DynamicParameters();
        // GET: Reports/Rpt_Payroll_ESICLimitCross
        public ActionResult Rpt_Payroll_ESICLimitCross(MonthWiseFilter MonthWiseFilter)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 507;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("ESIC Limit Cross"); 
                ...
                var GetDailyAttendanceReport = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Payroll_ESICLimitCross", paramList).ToList();
                ...
                worksheet.Cell(1, 1).Value = "ESIC Limit Cross Sheet Report - (" + DateTime.Now.ToString("MMMM yyyy") + ")";
