...
{
    public class Rpt_Payroll_YearWiseGratuityReportController : Controller
    {
        // GET: Reports/Rpt_Payroll_YearWiseGratuityReport
        public ActionResult Rpt_Payroll_YearWiseGratuityReport(MonthWiseFilter MonthWiseFilter)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 844;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime FromMonthYear, DateTime ToMonthYear)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("YearWiseGratuity");
                ...
                var GetDailyAttendanceReport = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Payroll_YearlyGratuityReport", paramList).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Year Wise Gratuity Report - (" + FromMonthYear.ToString("dd/MMM/yyyy") + " to " + ToMonthYear.ToString("dd/MMM/yyyy") + ")";
