...
{
    public class Rpt_Payroll_GradeWiseReportController : Controller
    {
        DynamicParameters param = new DynamicParameters();
        // GET: Reports/Rpt_Payroll_CategoryWiseSummary
        public ActionResult Rpt_Payroll_GradeWiseReport(MonthWiseFilter MonthWiseFilter)
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 667;
        ...
        public ActionResult DownloadExcelFile(int? CmpId, int? BranchId, DateTime Month, string Title)
        {
            try
            {
                ...
                var worksheet = workbook.Worksheets.Add("GradeWiseSummary");
                ...
                var GetDailyAttendanceReport = DapperORM.ExecuteSP<dynamic>("sp_Rpt_Payroll_GradeWiseSummary", paramList).ToList();
                ...
                worksheet.Cell(1, 1).Value = "Payroll Grade Wise Report - (" + Month.ToString("dd/MMM/yyyy") + " (" + Title + "))";
