...
{
    public class Report_Contractor_InvoiceReportController : Controller
    {
        #region Main View
        // GET: Reports/Report_Contractor_InvoiceReport
        public ActionResult Report_Contractor_InvoiceReport()
        {
            try
            {
                ...
                int screenId = Request.QueryString["ScreenId"] != null ? Convert.ToInt32(Request.QueryString["ScreenId"]) : 935;
